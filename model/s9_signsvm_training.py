...
Create and train SignSVM on FE training data
"""
...
if __name__ == "__main__":
    ...
    signsvm = SignNet(signnet_components).to(device)
    ...
    # Load neubernet and assign signsvm to it
    neubernet = torch.load("trained/neubernet.pt", weights_only=False)
    neubernet.signsvm = signsvm
