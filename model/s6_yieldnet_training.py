...
Script that creates and trains YieldNet on FE training data
"""
...
if __name__ == "__main__":
    ...
    yield_tol = config["yield_tol"]
    yield_small_pl_tol = config["yield_small_pl_tol"]
    ...
    nomad_hidden_dim = config["yield_nomad_hidden_dim"]
    ...
    yieldnet = YieldNet(yieldnet_components).to(device)
    ...
    neubernet.yieldnet = yieldnet
    neubernet.yield_tol = yield_tol
    neubernet.small_scale_pl_tol = yield_small_pl_tol
