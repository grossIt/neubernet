...
Generates N number of input files to be read by ANSYS
"""
...
for i in range(N):
    ...
    Fy_My_interp = sobol_samples[i, 6] * (Fy_My_interp_max - Fy_My_interp_min) + Fy_My_interp_min
    ...
    My_applied = My_max * np.sqrt(1 - (Fy_My_interp ** 2))  # We keep the same nominal equivalent stress
